omens = [
    ...
    },
	{
		name: "Feast",
		origin: "feast",
		Abandoned_Room: "lexiebday",
		Balcony: "lexiebday",
		Catacombs: "lexiebday",
		Charred_Room: "lexiebday",
		Dining_Room: "lexiebday",
		Furnace_Room: "lexiebday",
		Gallery: "lexiebday",
		Gymnasium: "lexiebday",
		Junk_Room: "lexiebday",
		Kitchen: "lexiebday",
		Master_Bedroom: "lexiebday",
		Pentagram_Chamber: "lexiebday",
		Servants_Quarters: "lexiebday",
...
function setSrc(name){
    ...
    expl.src = `description/${name}.html`;
}
...
function getHaunt() {
    ...
    let val = current_omen[room.item( room.selectedIndex).value]
    if(typeof val === "number")
        haunt.innerHTML = (val);
    else if ( val === undefined){
        haunt.innerHTML = "Not a valid combination";
    } else {
        haunt.innerHTML = '';
        let surviver = document.createElement("a");
        surviver.href = "haunts/" + val + "_survivor.html"
        surviver.innerHTML = "Custom haunt Survivor Link"
        haunt.appendChild(document.createElement("div")).appendChild(surviver);
        let traitor = document.createElement("div").appendChild(document.createElement("a"));
        traitor.href = "haunts/" + val + "_traitor.html"
        traitor.innerHTML = "Custom haunt Traitor Link"
        haunt.appendChild(document.createElement("div")).appendChild(traitor);
    }
}
